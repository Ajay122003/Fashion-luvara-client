...
export const fetchAdminUsers = async () => {
  const res = await adminClient.get("/api/admin-panel/users/");
  return res.data;
};

export const fetchAdminSubscriptions = async () => {
  const res = await adminClient.get("/api/admin-panel/subscriptions/");
  return res.data;
};
...
export const fetchAdminDashboardStats = async () => {
  const res = await adminClient.get("/api/admin-panel/dashboard/");
  return res.data;
};

export const fetchLowStockProducts = async () => {
  const res = await adminClient.get("/api/admin-panel/low-stock-products/");
  return res.data;
};
...
export const fetchAdminProducts = async () => {
  const res = await adminClient.get("/api/admin-panel/products/");
  return res.data;
};
...
export const fetchAdminCategories = async () => {
  const res = await adminClient.get("/api/admin-panel/categories/");
  return res.data;
};

export const fetchSingleAdminCategory = async (id) => {
  const res = await adminClient.get(
    `/api/admin-panel/categories/${id}/`
  );
  return res.data;
};
...
export const fetchAdminCollections = async () => {
  const res = await adminClient.get("/api/admin-panel/collections/");
  return res.data;
};

export const fetchSingleAdminCollection = async (id) => {
  const res = await adminClient.get(
    `/api/admin-panel/collections/${id}/`
  );
  return res.data;
};
...
export const fetchPublicSettings = async () => {
  const res = await adminClient.get(
    "/api/admin-panel/public-settings/"
  );
  return res.data;
};
...
export const fetchAdminCoupons = async () => {
  const res = await adminClient.get("/api/admin-panel/coupons/");
  return res.data;
};

export const createAdminCoupon = async (data) => {
  const res = await adminClient.post(
    "/api/admin-panel/coupons/",
    data
  );
  return res.data;
};
